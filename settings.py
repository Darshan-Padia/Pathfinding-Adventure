...
QUESTIONS = {
    ...
    "Total number of continents in the world is ": '7',
    ...
    "In which country is statue of liberty located? ": 'USA',
    "In which ocean bermuda trianlge is present? " : 'Atlantic',
    "Which continent has highest number of countries? ": 'Africa',
    "Which country is largest producer of tea in the world ": 'china',
    "In which country suez canal is located? ": 'egypt',
    "Highest building in the world ":'Burj khalifa',
    "Highest statue in the world ": 'statue of unity',
    "Largest tropical forest ": 'amazon',
    "Biggest island in the world ": 'Greenland',
    "Name the currency used in Belgium ": 'Euro',
    "The square root of 1764 is ": '1764'
